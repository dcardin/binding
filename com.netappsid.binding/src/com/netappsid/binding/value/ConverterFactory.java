...
/**
 * A factory that vends ValueModels that convert types, for example Dates to Strings. More formally, a converting ValueModel <i>VM1</i> converts the type
 * <i>T2</i> of an object being held as a value in one ValueModel <i>VM2</i> into another type <i>T1</i>. When reading a value from VM1, instances of T2 are
 * read from VM2 and are converted to T1. When storing a new value to VM1, the type converter will perform the inverse conversion and will convert an instance
 * of T1 to T2.
 * <p>
 * 
 * Type converters should be used judiciously and only to bridge two ValueModels. To bind non-Strings to a text UI component you should better use a
 * {@link javax.swing.JFormattedTextField}. They provide a more powerful means to convert strings to objects and handle many cases that arise around invalid
 * input. See also the classes {@link com.netappsid.binding.adapter.Bindings} and {@link com.netappsid.binding.adapter.BasicComponentFactory} on how to bind
 * ValueModels to formatted text fields.
 * <p>
 * 
...
public class ConverterFactory
{
	...
	@Inject
	protected ConverterFactory(ChangeSupportFactory changeSupportFactory)
	{
